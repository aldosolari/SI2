...
It follows that 
$$\frac{1}{t_{\alpha}} \int_{\mathcal{Y}_1 \setminus \mathcal{Y}'_1} f_1(y)dy\geq \int_{\mathcal{Y}_1 \setminus \mathcal{Y}'_1} f_0(y)dy \geq \int_{\mathcal{Y}'_1 \setminus\mathcal{Y}_1} f_0(y)dy \geq \frac{1}{t_{\alpha}} \int_{\mathcal{Y}'_1 \setminus\mathcal{Y}_1} f_1(y)dy$$
