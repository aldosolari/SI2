...
However, as noted by Soric (1989)
...
Then, we validate the previous inference on the test data:
...
<!-- ```{r} -->
<!-- moredem = df2$gov_dem/(df2$gov_dem + df2$gov_gop) > .5 -->
<!-- plot(gdp ~ date, df2, type="l", col="white") -->
<!-- lines(gdp ~ date, df2[1:4,], col=2) -->
<!-- lines(gdp ~ date, df2[4:21,], col=1) -->
<!-- lines(gdp ~ date, df2[21:72,], col=2) -->
<!-- lines(gdp ~ date, df2[72:84,], col=1) -->
<!-- lines(gdp ~ date, df2[84:180,], col=2) -->
<!-- lines(gdp ~ date, df2[180:228,], col=1) -->
<!-- lines(gdp ~ date, df2[228:244,], col=2) -->
<!-- lines(gdp ~ date, df2[244:261,], col=1) -->
<!-- ``` -->
...
<!-- 1. I'll begin by picking a stock — any stock will do. Then I'll choose 1024 innocent potential victims. -->

<!-- 2. I'll send them a prediction about what the stock will do over the next week. For half of them I'll predict that the stock will go up, and for the other half I'll predict that it will go down. Half of my potential victims will receive the wrong prediction, and half the right one. -->

<!-- 3. Now I'll forget about those who received the wrong prediction, and just focus on those who received the right prediction. For half of those, I'll now predict the stock will go up over the next week, and for the other half I’ll predict it will go down. And I’ll continue in this way, each time writing a new letter just to those who received the right prediction the previous week -->

<!-- 4. At the end of the 10th week, I’m down to just one person. Everyone else at some point received an incorrect prediction, and I stopped sending them new letters. But what about this one person? They’ve seen me make ten correct predictions in a row. And this is the point at which I ask to pay for my next stock tip... -->
