...
1. Does height depend on the type of fertilization? 

2. Could you estimate the height difference, and assess the uncertainty of the estimate?
...
*  **Analysis Plan**: Define a statistical model, and be very specific about the required assumptions. The less the assumptions the better. You can use different models to answer 1 and 2. 
* **Code**: Write the R code to get the results. You can add plots, statistical summaries, etc. Your code must be replicable. 
* **Claim:** Comment your results and write your conclusions about 1 and 2.
