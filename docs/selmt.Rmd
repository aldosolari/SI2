---
title: "The crisis of modern science and selective inference"
description: |
...
These are the problems that the area of *selective inference* attempts to address. In the following we will present examples and case studies to illustrate the issue of selection. 
...
### U.S. economy and politics: $p$-hacking
...
### Giovannucci et al. study: HARKing (Hypothesizing After the Results are Known) 

**Reference**: @goeman2016randomness
...
by Edward Giovannucci from Harvard @giovannucci1995intake. According to
